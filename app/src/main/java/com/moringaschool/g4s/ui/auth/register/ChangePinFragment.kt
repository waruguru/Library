package com.ekenya.android.g4saccesscsystem.ui.auth.register
...
import com.ekenya.android.g4saccesscsystem.databinding.FragmentChangePinBinding
...
class ChangePinFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnContinue.setOnClickListener {
            findNavController().navigate(R.id.action_changePinFragment_to_confirmPinFragment)
        }
    }
